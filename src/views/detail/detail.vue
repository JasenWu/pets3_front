<template>
  <div class="layout_index_index">
    <el-row :gutter="20">
      <el-col :offset="6" :span="12">
        <h3>
          ...
          <el-button style="float:right;" type="danger" @click="edit">Edit</el-button>
        ...
        <div class="layout_content">
          <ul>
            <li v-for="(item,index) in contentData.contents" :class="{'layout_right':item.role == 2,'layout_left':item.role == 1,'layout_des':item.role == 0}" :key="index" class="i_item" @click="toggleZh(item)">
    ...
    <el-dialog :title="dialog.content == 'add' ?'新增':'编辑'" :visible.sync="dialogVisible" :before-close="handleClose" width="30%">
      <el-form ref="ruleForm" :model="dialog.updateData" label-width="80px">
        <section v-for="(item,index) in dialog.updateData.roles" :key="index">
          <div style="padding-top:5px; margin-bottom:10px;">role {{ index+1 }}</div>
          <section style="border:1px dotted #ccc; padding:15px;">
            <el-form-item :prop="'roles['+index+'].name'" :rules="[
            ...
            <el-row :gutter="0">
              <el-col :span="12">
                <el-form-item :prop="'roles['+index+'].sex'" :rules="[
                    { required: true, message: 'please choose sex', trigger: ['blur', 'change'] },
                  ]" label="sex">
                  <el-select v-model="item.sex" placeholder="please choose gender">
                    <el-option label="males" value="1" />
                    <el-option label="females" value="0" />
                  </el-select>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item :prop="'roles['+index+'].type'" :rules="[
                    { required: true, message: 'please choose role type', trigger: ['blur', 'change'] },
                  ]" label="type">
                  <el-select v-model="item.type" placeholder="please choose role type">
                    <el-option label="aside" value="0" />
                    <el-option label="main role" value="1" />
                    <el-option label="support role" value="2" />
                  </el-select>
                </el-form-item>
              </el-col>
            ...
            <el-form-item :prop="'roles['+index+'].remark'" :rules="[
